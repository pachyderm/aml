...
curl -LO https://github.com/pachyderm/aml/raw/main/dist/azureml_dataprep_rslex-1.16.0.dev0%2B329a308-cp38-cp38-linux_x86_64.whl
/anaconda/envs/azureml_py38/bin/pip install azureml_dataprep_rslex-1.16.0.dev0%2B329a308-cp38-cp38-linux_x86_64.whl
